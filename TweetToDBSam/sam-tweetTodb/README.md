...
This is a sample template for sam-tweetTodb - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sam-tweettodb --query 'Stacks[].Outputs'
```
